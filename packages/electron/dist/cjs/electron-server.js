    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                const executeToolSafely = async (toolFunction) => {
                    try {
                ...
                switch (name) {
                    ...
                    case "evaluate":
                        const evalResult = await executeToolSafely(() => this.handleEvaluate(toolArgs.sessionId, toolArgs.script, toolArgs.windowId));
